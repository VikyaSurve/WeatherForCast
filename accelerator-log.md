...
{
  "gitBranch" : "main",
  "gitRepository" : "https://github.com/VikyaSurve/WeatherForCast",
  "liveUpdateIDESupport" : false,
  "projectName" : "weatherforcast",
  "targetProject" : "weatherforcast"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [my-project->weatherforcast]
